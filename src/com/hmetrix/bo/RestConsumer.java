...
public class RestConsumer {
	...
	public String processUrl(String completeurl, boolean authenticate,String credntialBean)
	{
		...
		try {
			...
			if(authenticate)
				urlConnection.setRequestProperty("Authorization", "Basic " + getAuthentication(credntialBean));
